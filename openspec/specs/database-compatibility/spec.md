# database-compatibility Specification

## Purpose
Define MoonBox's dual-database compatibility baseline: SQLite for local development, MySQL for production, with guarded configuration, compatible data access, repeatable validation, and durable documentation.
