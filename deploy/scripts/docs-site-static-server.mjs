...
<head>
  ...
  <title>MoonBox Docs Preview</title>
  <style>
    body { margin: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; background: #0f1419; color: #f6f3ec; }
...
<body>
  <main>
    <h1>MoonBox Docs Preview</h1>
    <p>Mintlify source is mounted and reachable. Use the links below to inspect product manuals and release pages.</p>
    <div class="grid">
